"""
data_loader.py - Data loading functions for credit risk probability modeling

This module contains functions to load data for credit risk probability modeling
